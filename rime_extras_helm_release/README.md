...
| <a name="input_prometheus_scrape_interval"></a> [prometheus\_scrape\_interval](#input\_prometheus\_scrape\_interval) | How often prometheus should scrape metrics. | `string` | `"60s"` | no |
