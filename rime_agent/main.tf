locals {
  ...
  # the service account name for the generative validation service.
  generative_model_testing_service_account_name = "rime-agent-generative-model-tester"
...
module "bedrock" {
  ...
  resource_name_suffix = "${var.resource_name_suffix}_agent"
  service_account_names = [
    local.generative_model_testing_service_account_name
  ]
...
resource "local_file" "terraform_provided_values" {
  content = templatefile("${path.module}/values_tmpl.yaml", {
    ...
    bedrock_access_role_arn          = module.bedrock.bedrock_access_role_arn
    ...
    generative_model_testing_service_account_name = local.generative_model_testing_service_account_name
