...
variable "openai_api_key" {
  description = "Open AI API key for using tests that rely on OpenAI models."
  type        = string
}
...
variable "file_storage_server_image" {
  description = "The name of the image to use for the firewall's file storage server, not including a tag."
  type        = string
  default     = "robustintelligencehq/rime-backend"
}

variable "file_storage_server_version" {
  description = "The version of the file storage server."
  type        = string
  default     = "latest"
}
