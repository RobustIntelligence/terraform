...
| [aws_iam_policy.ri_product_usage_data_bucket_access_policy](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_policy) | resource |
| [aws_iam_policy.ri_prometheus_read_role_access_policy](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_policy) | resource |
...
|------|-------------|------|---------|:--------:|
| <a name="input_cluster_enabled_log_types"></a> [cluster\_enabled\_log\_types](#input\_cluster\_enabled\_log\_types) | The list of log types to enable for the cluster. By default, all log types are enabled. | `list(string)` | <pre>[<br>  "api",<br>  "audit",<br>  "authenticator",<br>  "controllerManager",<br>  "scheduler"<br>]</pre> | no |
| <a name="input_cluster_endpoint_public_access_cidrs"></a> [cluster\_endpoint\_public\_access\_cidrs](#input\_cluster\_endpoint\_public\_access\_cidrs) | CIDR blocks to allow public access to the EKS control plane. | `list(string)` | <pre>[<br>  "0.0.0.0/0"<br>]</pre> | no |
| <a name="input_cluster_log_retention_in_days"></a> [cluster\_log\_retention\_in\_days](#input\_cluster\_log\_retention\_in\_days) | Number of days to retain log events. Default retention - 90 days. | `number` | `365` | no |
...
| <a name="input_private_cluster_endpoint_enabled"></a> [private\_cluster\_endpoint\_enabled](#input\_private\_cluster\_endpoint\_enabled) | Whether to enable the EKS control plane's private cluster endpoint. | `bool` | `true` | no |
...
| <a name="input_public_cluster_endpoint_enabled"></a> [public\_cluster\_endpoint\_enabled](#input\_public\_cluster\_endpoint\_enabled) | Whether to enable the EKS control plane's public cluster endpoint. | `bool` | `true` | no |
