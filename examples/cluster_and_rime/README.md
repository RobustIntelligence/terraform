...
Specific values have been annotated in-place in the `main.tf` files, and full coverage of a module's variables can be found in its README (e.g., [rime_eks_cluster](../../rime_eks_cluster/README.md)).
...
For a full list of the possible variables, see [rime_eks_cluster](../../rime_eks_cluster/README.md).
...
For a full list of the possible values, see [rime_kube_system_helm_release](../../rime_kube_system_helm_release/README.md).
...
For a full list of the possible values, see [rime_extras_helm_release](../../rime_extras_helm_release/README.md).
