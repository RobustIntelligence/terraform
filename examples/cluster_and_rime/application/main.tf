...
locals {
  ...
  # The name of the Helm release for the deployment of the 'rime' Helm chart
  release_name = ""
...
module "rime_helm_release" {
  source    = "github.com/RobustIntelligence/terraform//rime_helm_release?ref=2.3.X"
...
module "rime_agent_release" {
  source     = "github.com/RobustIntelligence/terraform//rime_agent?ref=2.3.X"
  ...
  cp_release_name  = local.release_name
...
module "rime_acm_certs" {
  source                    = "github.com/RobustIntelligence/terraform//rime_acm_certs?ref=2.3.X"
