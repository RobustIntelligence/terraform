...
| <a name="input_install_kserve"></a> [install\_kserve](#input\_install\_kserve) | Whether or not to install kserve. Only turn this on for clusters with the firewall installed. | `bool` | `false` | no |
