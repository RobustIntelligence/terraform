...
variable "yara_github_app_pem" {
  description = "Base64 encoded private key to authenticate the hotfixyara server with Github as an app."
  type        = string
}
...
variable "cloudfront_waf_enabled" {
  description = "enable cloudfront and waf"
  type        = bool
  default     = true
}

variable "cloudfront_waf_cert_arn" {
  description = "The ARN for the wildcard Cloudfront ACM certificate."
  type        = string
  default     = ""
}
