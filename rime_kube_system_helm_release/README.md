...
| <a name="input_enable_cert_manager"></a> [enable\_cert\_manager](#input\_enable\_cert\_manager) | Whether or not to install cert-manager. If not installed, we expect you to have some version of cert-manager installed or to not use internal tls. | `bool` | `true` | no |
