...
| <a name="input_install_cert_manager"></a> [install\_cert\_manager](#input\_install\_cert\_manager) | Whether or not to install cert-manager. If not installed, we expect you to have some version of cert-manager installed or to not use internal tls. | `bool` | `true` | no |
