...
variable "enable_cert_manager" {
  description = "Whether or not to install cert-manager. If not installed, we expect you to have some version of cert-manager installed or to not use internal tls."
  type        = bool
  default     = true
}
