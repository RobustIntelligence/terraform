...
| <a name="input_humio_hostname"></a> [humio\_hostname](#input\_humio\_hostname) | Hostname of the cloud instance of the humio server | `string` | `""` | no |
| <a name="input_humio_ingest_token"></a> [humio\_ingest\_token](#input\_humio\_ingest\_token) | Ingest token for the cloud instance of the humio server | `string` | `""` | no |
...
| <a name="input_install_humio_fluentbit"></a> [install\_humio\_fluentbit](#input\_install\_humio\_fluentbit) | Whether or not to install the Humio(Crowdstrike) fluent bit agent. | `bool` | `false` | no |
